      ...
      var _nestShotsByLocation = function(data) {
          var nestedData = d3.nest()
              ...
              .rollup(function(v) { return {
                  ...
                  "attempts": d3.sum(v, function(d) { return d.shot_attempted_flag }),
                  "shootingPercentage":  d3.sum(v, function(d) { return d.shot_made_flag })/d3.sum(v, function(d) { return d.shot_attempted_flag })
              }})
              .entries(data);
              ...
              if (activeDisplay === "scatter"){
                  ...
                  if (toolTips) {
                      var tool_tip = d3.tip()
                        ...
                        .offset([-8, 0])
                        .html(function(d) {
                              return d.shot_distance + "' " + d.action_type + "<br /> x:" + d.x + "<br /> y:" + d.y + "<br /> assited by: " + d.assist;
                          });
