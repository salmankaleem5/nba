from util.shot_chart.shot_chart import get_shots_for_all_players_season, get_shots_for_player_season
...
# get_all_season_player('Anthony Davis', range(2012, 2018))
get_all_players_season('2017-18')
