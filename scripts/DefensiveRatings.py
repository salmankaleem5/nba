...
base = GeneralPlayerStats().get_data({'Season': season, 'PerMode': per_mode}, override_file=data_override)[
...
hustle = HustleStats().get_data({'Season': season, 'PerMode': per_mode}, override_file=data_override)[
...
merge_df = merge_df[merge_df.MIN >= 75]
